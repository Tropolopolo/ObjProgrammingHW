...
{
	public:
		Animal(std::string n = "Ditto", int id = 1, bool g = 0, int a = 20, std::string hs = "Good", std::string t = "Animal", std::string s = "Unidentified") : name(n), id_number(id), gender(g), age(a), health_status(hs), type(t), species(s) {};
