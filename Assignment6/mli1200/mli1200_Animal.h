...
{
	public:
		Animal(std::string n = "matt", int id = 1, bool g = 0, int a = 20, std::string hs = "Good", std::string t = "Dog", std::string s = "Animal") : name(n), id_number(id), gender(g), age(a), health_status(hs), type(t), species(s) {};
